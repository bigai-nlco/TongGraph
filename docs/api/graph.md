...
| `create_vector_index`, `drop_vector_index`, `vector_indexes`, `upsert_vector`, `upsert_vectors`, `get_vector`, `delete_vector`, `delete_vectors`, `search_vector`, `search_vectors` | [Vector search](../design/vector-search.md) |
